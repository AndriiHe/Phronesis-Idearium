        ...
        <Box mb="40px">
          <Tiles justifyContent="space-around" flexWrap="wrap" type="wide">
            <Tile to="/developer-portal" header="Rock" textAlign="left">
              Redocly offers quick access to training exercises, helping users build skills with practical, easy-to-follow modules.
            </Tile>
            <Tile to="/developer-portal" header="Paper" textAlign="left">
              Redocly simplifies training with focused exercises and resources for efficient skill-building.
            </Tile>
            <Tile to="/developer-portal" header="Scissors" textAlign="left">
              Redocly provides hands-on training exercises, tailored for developers to learn and grow effectively.
            </Tile>
            <Tile to="/developer-portal" header="Go" textAlign="left">
              A hub for training, the developer portal delivers concise, practical exercises to boost developer skills.
            </Tile>
          </Tiles>
        </Box>
      </Box>
